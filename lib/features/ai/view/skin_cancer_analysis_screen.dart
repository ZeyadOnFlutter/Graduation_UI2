          ...
          if (state is CombinedAnalysisSuccess) {
            Navigator.push(context, MaterialPageRoute(
              builder: (_) => AnalysisResultScreen(
                disease: _disease, color: _color, icon: '🔆', result: state,
              ),
            ));
                      ...
                      child: Padding(
                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            SizedBox(height: 4.h),
                            Text('Skin Cancer Analysis', style: TextStyle(fontSize: 22.sp, fontWeight: FontWeight.bold, color: Colors.white)),
                            Text('Complete all sections for accurate results', style: TextStyle(fontSize: 13.sp, color: Colors.white70)),
                          ],
                        ),
                      ),
                    ),
                ...
                sliver: SliverList(
                  delegate: SliverChildListDelegate([
                    ...
                    AnalysisImagePicker(
                      image: _image,
                      color: _color,
                      samplePath: 'assets/images/skin.png',
                      onPick: _pickImage,
                    ...
                    SizedBox(height: 10.h),
                    _dropdown('2. Natural hair color?', _hairColor, ['Black', 'Red', 'Blonde', 'Light Brown', 'Dark Brown'], (v) => _hairColor = v),
                    SizedBox(height: 10.h),
                    _dropdown('3. Do you have freckles?', _freckles, ['None', 'Few', 'Moderate', 'Many'], (v) => _freckles = v),
                    SizedBox(height: 10.h),
                    _dropdown('4. How many moles on your body?', _numberOfMoles, ['0-10', '11-25', '26-50', '51-100', 'More than 100'], (v) => _numberOfMoles = v),
                    SizedBox(height: 10.h),
                    _dropdown('5. Moles larger than 5mm?', _molesLarger5mm, ['None', '1-2', '3-5', 'More than 5'], (v) => _molesLarger5mm = v),
                    SizedBox(height: 10.h),
                    _yesNo('6. Mole or skin spot changing in size, shape, or color?', _changingMole, (v) => _changingMole = v),
                    SizedBox(height: 10.h),
                    _yesNo('7. New or unusual skin growths recently?', _newGrowth, (v) => _newGrowth = v),
                    SizedBox(height: 10.h),
                    _dropdown('8. How easily does your skin burn?', _skinBurn, ['Never', 'Rarely', 'Sometimes', 'Often', 'Always'], (v) => _skinBurn = v),
                    SizedBox(height: 10.h),
                    _dropdown('9. How well does your skin tan?', _tanningAbility, ['Tans easily and deeply', 'Tans gradually', 'Rarely tans', 'Never tans'], (v) => _tanningAbility = v),
                    SizedBox(height: 10.h),
                    _dropdown('10. Sunburns as a child?', _sunburnsChildhood, ['None', '1-2', '3-5', 'More than 5'], (v) => _sunburnsChildhood = v),
                    SizedBox(height: 10.h),
                    _yesNo('11. Ever had a severe, blistering sunburn?', _severeSunburn, (v) => _severeSunburn = v),
                    SizedBox(height: 10.h),
                    _dropdown('12. Daily sun exposure hours?', _dailySunExposure, ['Less than 1 hour', '1-3 hours', '3-6 hours', 'More than 6 hours'], (v) => _dailySunExposure = v),
                    SizedBox(height: 10.h),
                    _dropdown('13. Time spent outdoors?', _outdoorWork, ['Rarely', 'Sometimes', 'Often', 'Daily'], (v) => _outdoorWork = v),
                    SizedBox(height: 10.h),
                    _dropdown('14. Tanning bed use?', _tanningBed, ['Never', 'Occasionally', 'Regularly (monthly)', 'Frequently (weekly)'], (v) => _tanningBed = v),
                    SizedBox(height: 10.h),
                    _dropdown('15. Years of tanning bed use?', _yearsTanningBed, ['Never used', 'Less than 1 year', '1-5 years', 'More than 5 years'], (v) => _yearsTanningBed = v),
                    SizedBox(height: 10.h),
                    _yesNo('16. Personal history of skin cancer?', _personalHistory, (v) => _personalHistory = v),
                    SizedBox(height: 10.h),
                    _dropdown('17. Family history of skin cancer?', _familyHistory, ['None', 'One relative', 'Two or more relatives'], (v) => _familyHistory = v),
                    SizedBox(height: 10.h),
                    _yesNo('18. Taking immunosuppressive medication?', _immunosuppressive, (v) => _immunosuppressive = v),
                    SizedBox(height: 10.h),
                    _yesNo('19. Ever received radiation therapy?', _radiationTherapy, (v) => _radiationTherapy = v),
                    SizedBox(height: 10.h),
                    _dropdown('20. UV level of your region?', _geographicUV, ['Low UV region', 'Moderate UV region', 'High UV region'], (v) => _geographicUV = v),
                    SizedBox(height: 10.h),
                    _dropdown('21. Years lived in high UV area?', _yearsHighUV, ['Never', 'Less than 5 years', '5-15 years', 'More than 15 years'], (v) => _yearsHighUV = v),
                    SizedBox(height: 10.h),
                    _dropdown('22. How often do you check your skin?', _skinSelfCheck, ['Monthly', 'Every few months', 'Once a year', 'Rarely', 'Never'], (v) => _skinSelfCheck = v),
                    SizedBox(height: 10.h),
                    _dropdown('23. How often do you visit a dermatologist?', _dermatologist, ['More than once a year', 'Annually', 'Once every few years', 'Never'], (v) => _dermatologist = v),
                    SizedBox(height: 10.h),
                    _dropdown('24. Diet rich in antioxidants?', _dietAntioxidants, ['Often', 'Sometimes', 'Rarely', 'Never'], (v) => _dietAntioxidants = v),
                    ...
                    TextField(
                      ...
                      decoration: InputDecoration(
                        ...
                        border: OutlineInputBorder(borderRadius: BorderRadius.circular(14.r), borderSide: BorderSide(color: Colors.grey.shade200)),
                        ...
                        focusedBorder: OutlineInputBorder(borderRadius: BorderRadius.circular(14.r), borderSide: const BorderSide(color: _color)),
                      ),
                    ),
                            ...
                            child: loading
                                ...
                                : Row(
                                    ...
                                    children: [
                                      ...
                                      SizedBox(width: 8.w),
                                      Text('Analyze', style: TextStyle(fontSize: 16.sp, fontWeight: FontWeight.bold, color: Colors.white)),
                                    ],
                                  ),
                          ),
                        );
